...
class BenchmarkRun(Base):
    ...
    brand_accuracy: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    mpn_accuracy: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    attribute_accuracy: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    ...
    predictions_hash: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    status: Mapped[str] = mapped_column(String(64), default="completed", nullable=False)
...
class BenchmarkResult(Base):
    ...
    predicted_brand: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    predicted_category: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    predicted_invoice: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    expected_brand: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    expected_category: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    expected_invoice: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    confidence: Mapped[float] = mapped_column(Float, default=1.0, nullable=False)
    source_mode: Mapped[str] = mapped_column(String(64), default="OFFLINE_HEURISTIC", nullable=False)
